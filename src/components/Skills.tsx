...
// import { FaReact, FaNodeJs, FaJs, FaPython, FaGitAlt, FaJava, FaDatabase } from 'react-icons/fa';
...
//             <div key={skill.name} className={`mb-6 skill-item-${index} flex items-center space-x-4`}>
